...
export var LEVEL_CHART_OPTIONS: any = { y_axis: [-70, 70, 10], margin: { top: 20, left: 40, right: 200, bottom: 40 }, width: CHART_WIDTH, height: CHART_HEIGHT, x_ticks: 10 };
export var WATERFALL_CHART_OPTIONS: any = { heat: [-70, 0, 70], margin: { top: 20, left: 80, right: 80, bottom: 30 }, width: CHART_WIDTH, height: CHART_HEIGHT, y_ticks: 8 };
