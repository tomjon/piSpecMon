...
@Component({
  ...
  template: `<psm-widget title="System Logs">
               <form role="form">
                 ...
                 <div class="form-group">
                   <button class="btn btn-default" (click)="onClick('server')">Server</button>
                   <button class="btn btn-default" (click)="onClick('worker')">Spectrum scan</button>
                   <button class="btn btn-default" (click)="onClick('monkey')">RDS scan</button>
                 </div>
               </form>
             </psm-widget>`
})
